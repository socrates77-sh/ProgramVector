...
Module vecMC33P78
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P11,P10,P27,P26,P25,P24,P23,P22,P21,P20,P12,P13,P14,P15,P16,P17; ")
        sw.WriteLine("START:RPT 100        (XXX0XXXXXXXXXX0X)TS0;//VPP")
    End Sub

    Private Sub VecTail()
        sw.WriteLine("STOP:                (XXX0XXXXXXXXXX0X);")
    End Sub
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXXXX);   //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX1X);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX0X);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXXXX);   //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX1X);   //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX0X);   //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXXXX);   //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX1X);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX0X);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXXXX);   //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX0X);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXH0X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXXXX0X);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXXXL0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (XXX1XXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 1000             (XXX0XXXXXXXXXXXX);   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXX1XXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (XXX0XXXXXXXXXXXX); ") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXX1XXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXXXX);") & vbCrLf
        Next
