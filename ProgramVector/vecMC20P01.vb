...
Module vecMC20P01
    ...
    Private Sub PinInfo()
        ...
        sw.Write("//000111111000" & vbCrLf)
        sw.Write("//210012345543" & vbCrLf & vbCrLf)
    End Sub
    ...
    Private Sub ProgInit(ByVal nID As Integer)
        ...
        sVec &= String.Format("  XXXXXXX11XXX; RPT 1000;") & vbCrLf & vbCrLf
        sVec &= String.Format("  XXXXXXX11XXX; RPT 10;        //(INIT) ID:{0:X4}", nID) & vbCrLf
        m = &H1000
        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXXXXXX10XXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXX11XXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nID And m) = 0 Then
                    sVec &= String.Format("  XXXXXXL00XXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXL01XXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXL10XXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXL11XXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i = 27 Then
                sVec &= String.Format("  XXXXXXX10XXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXX11XXX;") & vbCrLf
            Else
                sVec &= String.Format("  XXXXXXL10XXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXL11XXX;") & vbCrLf
            End If
        Next
    ...
    Private Sub Write(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXXXXXX11XXX; RPT 10;        //(WR) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80

        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXXXXXX00XXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXH01XXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nAddr And m) = 0 Then
                    sVec &= String.Format("  XXXXXXH00XXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXH01XXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXH10XXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXH11XXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXXXXXH00XXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXH01XXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXH10XXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXH11XXX;") & vbCrLf
                End If
                md = md >> 1
            ElseIf i = 14 Then
                ...
                sVec &= String.Format("  XXXXXXL11XXX;") & vbCrLf
            ElseIf i = 26 Then
                sVec &= String.Format("  XXXXXXL10XXX; RPT 1000;      //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXL11XXX; RPT 1000;") & vbCrLf
            ElseIf i = 27 Then
                sVec &= String.Format("  XXXXXXX10XXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXX11XXX;") & vbCrLf
            Else
                sVec &= String.Format("  XXXXXXH10XXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXH11XXX;") & vbCrLf
            End If
        Next
    ...
    Private Sub Read(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXXXXXX11XXX; RPT 10;        //(RD) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80
        ...
        For i = 0 To 27
            ...
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXXXXXL10XXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXX11XXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXH10XXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXX11XXX;") & vbCrLf
