...
Module vecMC32P7511
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P16,P15,P14,P13,P12,P11,P10,P00,P01,P02,P03,P04,P05,P06;")
        'sw.WriteLine("START:               (XXXXXX00XXXX)TS0;")
    End Sub

    Private Sub VecTail()
        sw.WriteLine("STOP:                (XXX0XXXXX0XXXX);")
    End Sub
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (XXX0XXXXX1XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX1XXXX);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX1XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX0XXXX);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (XXX0XXXXX1XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX1XXXX);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX1XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX0XXXX);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX0XXXXX1XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX1XXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX1XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX0XXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX0HXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXX0LXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        Next
        sVec &= String.Format("RPT 1000             (XXX0XXXXXXXXXX);   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXX1XXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);") & vbCrLf
        Next
