...
Module vecMC30P011
    Const ID As UInt16 = &H3011
    Const ID_ADDR As UInt16 = &H3FFF
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P00,P17,P16,P15,P14,P13,P12,P11,P10,P03,P02,P01;" & vbCrLf)
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 10         (XXXXXXX00XXX);   //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("               (XXXXXXX11XXX);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("               (XXXXXXX10XXX);") & vbCrLf
            Else
                sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 10         (XXXXXXX00XXX);   //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 1 To 14
            If addr And m Then
                sVec &= String.Format("               (XXXXXXX11XXX);   //T{0:D} addr[{1:D}]", i, i - 1) & vbCrLf
                sVec &= String.Format("               (XXXXXXX10XXX);") & vbCrLf
            Else
                sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D} addr[{1:D}]", i, i - 1) & vbCrLf
                sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 10         (XXXXXXX00XXX);   //DataIn 0x{0:X4}", data) & vbCrLf
        sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 1 To 14
            If data And m Then
                sVec &= String.Format("               (XXXXXXX11XXX);   //T{0:D} data[{1:D}]", i, i - 1) & vbCrLf
                sVec &= String.Format("               (XXXXXXX10XXX);") & vbCrLf
            Else
                sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D} data[{1:D}]", i, i - 1) & vbCrLf
                sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 10         (XXXXXXX00XXX);   //DataOut 0x{0:X4}", data) & vbCrLf
        sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 1 To 14
            If data And m Then
                sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D} data[{1:D}]", i, i - 1) & vbCrLf
                sVec &= String.Format("               (XXXXXXH00XXX);") & vbCrLf
            Else
                sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D} data[{1:D}]", i, i - 1) & vbCrLf
                sVec &= String.Format("               (XXXXXXL00XXX);") & vbCrLf
            End If
            m <<= 1
        Next
