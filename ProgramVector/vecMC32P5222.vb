...
Module vecMC32P5222
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P11,P10,P27,P26,P25,P24,P22,P21,P12,P13,P14,P15,P16,P17;")
        sw.WriteLine("START:               (XXX0XXXXXXXX0X);")
    End Sub

    Private Sub VecTail()
        sw.WriteLine("STOP:                (XXX0XXXXXXXX0X);")
    End Sub
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);    //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXX1X);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXX0X);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);    //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXX1X);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXX0X);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);   //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXX1X);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXX0X);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);    //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXH0X);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXXL0X);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (XXX1XXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 550              (XXX0XXXXXXXXXX);   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXX1XXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (XXX0XXXXXXXXXX);") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXX1XXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XXXXXXXXXX);") & vbCrLf
        Next
