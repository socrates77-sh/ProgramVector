...
Module vecMC32P7510
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P00,P15,P01,P03,P04,P06,P10,P11,P12,P02,P13,P14,P05,P16;")
        'sw.WriteLine("START:               (XXXXXX00XXXX)TS0;")
    End Sub

    Private Sub VecTail()
        sw.WriteLine("STOP1:               (X0XXXXXXX0XXXX);")
    End Sub
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (X0XXXXXXXXXXXX);    //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (X0XXXXXXX1XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX1XXXX);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX1XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX0XXXX);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (X0XXXXXXXXXXXX);    //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (X0XXXXXXX1XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX1XXXX);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX1XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX0XXXX);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (X0XXXXXXXXXXXX);   //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (X0XXXXXXX1XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX1XXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX1XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX0XXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (X0XXXXXXXXXXXX);    //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX0XXHX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
                sVec &= String.Format("                     (X1XXXXXXX0XXLX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (X0XXXXXXX0XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (X1XXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (X0XXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 1000             (X0XXXXXXXXXXXX);   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (X1XXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (X0XXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (X0XXXXXXXXXXXX);") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (X1XXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (X0XXXXXXXXXXXX);") & vbCrLf
        Next
