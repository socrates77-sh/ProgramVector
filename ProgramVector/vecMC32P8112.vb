...
Module vecMC32P8112
    ...
    Function GenVec(ByVal sChip As String, ByVal sProj As String, ByVal sS19 As String, _
        ...
        OPT1 = OPT Or &H8000L   'OPBIT0, bit15
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P02,P03,P04,P05,P06,P07,P11,P10,P12,P13,P31,P30,P27,P26,P25,P24,P23,P22,P20,P21,P17,P16,P15,P14,P00,P01;")
        'sw.WriteLine("START:               (XXXXXX00XXXX);")
    End Sub

    Private Sub VecTail()
        'sw.WriteLine("STOP:                (XXXXXX00XXXX);")
    End Sub
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXX0XXXXXXXXXXXXXXXXX);   //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (XXXXXX1X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX1X1XXXXXXXXXXXXXXXXX);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX1X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X1XXXXXXXXXXXXXXXXX);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXX0XXXXXXXXXXXXXXXXX);   //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (XXXXXX1X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX1X1XXXXXXXXXXXXXXXXX);   //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX1X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X1XXXXXXXXXXXXXXXXX);   //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXX0XXXXXXXXXXXXXXXXX);   //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXXXXX1X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX1X1XXXXXXXXXXXXXXXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX1X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X1XXXXXXXXXXXXXXXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXX0XXXXXXXXXXXXXXXXX);   //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX0H1XXXXXXXXXXXXXXXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX0L1XXXXXXXXXXXXXXXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX0X0XXXXXXXXXXXXXXXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (XXXXXXXX1XXXXXXXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXXXX0XXXXXXXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 1000             (XXXXXXXX0XXXXXXXXXXXXXXXXX);   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXXXXX1XXXXXXXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXXXX0XXXXXXXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (XXXXXXXX0XXXXXXXXXXXXXXXXX);") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXXXXX1XXXXXXXXXXXXXXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXXXX0XXXXXXXXXXXXXXXXX);") & vbCrLf
        Next
