...
Module vecMC32P7541
    ...
    Function GenVec(ByVal sChip As String, ByVal sProj As String, ByVal sS19 As String, _
        ...
        sLog &= "CRC: " & CheckSum.ToString("X4") & vbCrLf
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (0XXXXXXXXXXXXXXX);    //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (01XXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (11XXXXXXXXXXXXXX);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (01XXXXXXXXXXXXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (00XXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (10XXXXXXXXXXXXXX);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (00XXXXXXXXXXXXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (0XXXXXXXXXXXXXXX);    //Address 0x{0:X4}", addr) & vbCrLf
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (0XXXXXXXXXXXXXXX);    //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (0XXXXXXXXXXXXXXX);    //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                ...
                sVec &= String.Format("                     (10XXXXXXXXXXXXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (00XXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (00HXXXXXXXXXXXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (00XXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (10XXXXXXXXXXXXXX);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (00XXXXXXXXXXXXXX);") & vbCrLf
                sVec &= String.Format("                     (00LXXXXXXXXXXXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (1XXXXXXXXXXXXXXX);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (0XXXXXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 500              (0XXXXXXXXXXXXXXX);    //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (1XXXXXXXXXXXXXXX);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (0XXXXXXXXXXXXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (0XXXXXXXXXXXXXXX);") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (1XXXXXXXXXXXXXXX);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (0XXXXXXXXXXXXXXX);") & vbCrLf
        Next
