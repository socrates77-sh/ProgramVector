...
Module vecMC32P7030
    ...
    Const PAGE As UInt16 = &HFFF3       '1K first page
    ...
    Private Sub GenWrite()
        Try
            ...
            CmdDataIn(PAGE)
            CmdProg()
            CmdAddress(&H8005)  'write OPBIT0
            CmdDataIn(OPT1 And &HFFFFL)
            CmdProg()
            CmdAddress(&H8007)  'write OPBIT2
    ...
    Private Sub GenVerify()
        Try
            ...
            CmdDataOut(PAGE)
            CmdAddress(&H8005)  'read OPBIT0
            CmdDataOut(OPT1 And &HFFFFL)
            CmdAddress(&H8007)  'read OPBIT2
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P03,P54,P04,P53,P02,P01,P00,P40,P41,P42,P43,P44;")
        sw.WriteLine("START:               (XXX0XXXXXXX0)TS0;")
    End Sub

    Private Sub VecTail()
        sw.WriteLine("STOP:RPT 5           (XXXXXXXXXXX0); ")
    End Sub
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXXXXX0);    //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (XXX1XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXX1);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXX0);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX1);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXXXXX0);    //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (XXX1XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXX1);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXX0);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX1);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXXXXX0);    //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX1XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXX1);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX1XXXXXXX0);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX1);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXXXXXXX0);    //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX1);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0HXXXXXX0);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXX0XXXXXXX0);") & vbCrLf
                sVec &= String.Format("                     (XXX0XXXXXXX1);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXX0LXXXXXX0);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (XXXXXXXXXXX1);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXXXXXXX0);") & vbCrLf
        Next
        sVec &= String.Format("RPT 1000             (XXXXXXXXXXX0);    //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXXXXXXXX1);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXXXXXXX0);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (XXXXXXXXXXX0);") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXXXXXXXX1);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXXXXXXX0);") & vbCrLf
        Next
