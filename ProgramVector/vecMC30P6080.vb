...
Module vecMC30P6080
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P00,P17,P16,P15,P14,P13,P12,P11,P10,P03,P02,P01;")
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (XXXXXX0XXXXX);   //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (XXXXXX01XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX11XXXX);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX01XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX10XXXX);   //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXX0XXXXX);   //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (XXXXXX01XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX11XXXX);   //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX01XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX10XXXX);   //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXX0XXXXX);   //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXXXXX01XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX11XXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX01XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX10XXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXXX0XXXXX);   //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX10HXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
                sVec &= String.Format("                     (XXXXXX10LXXX);   //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXXX00XXXX);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (XXXXXX1XXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXX0XXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 550              (XXXXXX0XXXXX);   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXXX1XXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXX0XXXXX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (XXXXXX0XXXXX);") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXXX1XXXXX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXXX0XXXXX);") & vbCrLf
        Next
