...
Module vecMC31P11
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P16,P15,P14,P13,P12,P11,P10,P00,P01,P02,P03,P04,P05,P06;" & vbCrLf)
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 5      //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("      (X0XXXXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("      (X1XXXXXXXXXX1X);               //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("      (X1XXXXXXXXXX0X);               //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 5      //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("      (X0XXXXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("      (X1XXXXXXXXXX1X);               //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("      (X1XXXXXXXXXX0X);               //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 5      //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("      (X0XXXXXXXXXX1X);") & vbCrLf
                sVec &= String.Format("      (X1XXXXXXXXXX1X);               //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX1X);") & vbCrLf
            Else
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("      (X1XXXXXXXXXX0X);               //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 5      //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("      (X1HXXXXXXXXX0X);               //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
            Else
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
                sVec &= String.Format("      (X1LXXXXXXXXX0X);               //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("      (X0XXXXXXXXXX0X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("      (X1XXXXXXXXXX0X);               //T{0:D}", i) & vbCrLf
            sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 5") & vbCrLf
        Next
        sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 1000   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("      (X1XXXXXXXXXX0X);               //T{0:D}", i) & vbCrLf
            sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 5") & vbCrLf
        Next
        sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 20") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("      (X1XXXXXXXXXX0X);               //T{0:D}", i) & vbCrLf
            sVec &= String.Format("      (X0XXXXXXXXXXXX);    RPT 5") & vbCrLf
        Next
