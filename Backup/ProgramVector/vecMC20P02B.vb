...
Module vecMC20P02B
    ...
    Private Sub PinInfo()
        sw.Write("//PPPPPPPPPPPPPPPPPP" & vbCrLf)
        sw.Write("//111110000000022111" & vbCrLf)
        sw.Write("//345670123456710012" & vbCrLf & vbCrLf)
    End Sub
    ...
    Private Sub ProgInit(ByVal nID As Integer)
        ...
        sVec &= String.Format("  XXX1X1XXXXXXXXXXXX; RPT 1000;") & vbCrLf & vbCrLf
        sVec &= String.Format("  XXX1X1XXXXXXXXXXXX; RPT 10;        //(INIT) ID:{0:X4}", nID) & vbCrLf
        m = &H1000
        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXX0X1XXXXXXXXXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXX1X1XXXXXXXXXXXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nID And m) = 0 Then
                    sVec &= String.Format("  XXX0X0XXXXXXLXXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X0XXXXXXLXXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXX0X1XXXXXXLXXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X1XXXXXXLXXXXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i = 27 Then
                sVec &= String.Format("  XXX0X1XXXXXXXXXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXX1X1XXXXXXXXXXXX;") & vbCrLf
            Else
                sVec &= String.Format("  XXX0X1XXXXXXLXXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXX1X1XXXXXXLXXXXX;") & vbCrLf
            End If
        Next
    ...
    Private Sub Write(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXX1X1XXXXXXXXXXXX; RPT 10;        //(WR) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80

        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXX0X0XXXXXXXXXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXX1X0XXXXXXHXXXXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nAddr And m) = 0 Then
                    sVec &= String.Format("  XXX0X0XXXXXXHXXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X0XXXXXXHXXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXX0X1XXXXXXHXXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X1XXXXXXHXXXXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXX0X0XXXXXXHXXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X0XXXXXXHXXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXX0X1XXXXXXHXXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X1XXXXXXHXXXXX;") & vbCrLf
                End If
                md = md >> 1
            ElseIf i = 14 Then
                ...
                sVec &= String.Format("  XXX1X1XXXXXXLXXXXX;") & vbCrLf
            ElseIf i = 26 Then
                sVec &= String.Format("  XXX0X1XXXXXXLXXXXX; RPT 1000;      //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXX1X1XXXXXXLXXXXX; RPT 1000;") & vbCrLf
            ElseIf i = 27 Then
                sVec &= String.Format("  XXX0X1XXXXXXXXXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXX1X1XXXXXXXXXXXX;") & vbCrLf
            Else
                sVec &= String.Format("  XXX0X1XXXXXXHXXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXX1X1XXXXXXHXXXXX;") & vbCrLf
            End If
        Next
    ...
    Private Sub Read(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXX1X1XXXXXXXXXXXX; RPT 10;        //(RD) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80
        ...
        For i = 0 To 27
            ...
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXX0X1XXXXXXLXXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X1XXXXXXXXXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXX0X1XXXXXXHXXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXX1X1XXXXXXXXXXXX;") & vbCrLf
