...
Module vecMC20P24B
    Const ID As Integer = &H224
    Const ADDRL As Integer = &H1000            'Valid lowest address
    ...
    Private Sub PinInfo()
        ...
        sw.Write("//111222222200000000" & vbCrLf)
        sw.Write("//012012345676543210" & vbCrLf & vbCrLf)
    End Sub
    ...
    Private Sub ProgInit(ByVal nID As Integer)
        ...
        sVec &= String.Format("  XXXXXXXXXXXXXXX11X; RPT 1000;") & vbCrLf & vbCrLf
        sVec &= String.Format("  XXXXXXXXXXXXXXX11X; RPT 10;        //(INIT) ID:{0:X4}", nID) & vbCrLf
        m = &H1000
        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXXXXXXXXXXXXXX01X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXXXXXXXXXX11X;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nID And m) = 0 Then
                    sVec &= String.Format("  XXXXXXXXXXXXXXX00L;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX10L;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXXXXXXXXXX01L;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX11L;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i = 27 Then
                sVec &= String.Format("  XXXXXXXXXXXXXXX01X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXXXXXXXXXX11X;") & vbCrLf
            Else
                sVec &= String.Format("  XXXXXXXXXXXXXXX01L;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXXXXXXXXXX11L;") & vbCrLf
            End If
        Next
    ...
    Private Sub Write(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXXXXXXXXXXXXXX11X; RPT 10;        //(WR) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80

        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXXXXXXXXXXXXXX00X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXXXXXXXXXX10H;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nAddr And m) = 0 Then
                    sVec &= String.Format("  XXXXXXXXXXXXXXX00H;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX10H;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXXXXXXXXXX01H;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX11H;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXXXXXXXXXXXXXX00H;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX10H;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXXXXXXXXXX01H;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX11H;") & vbCrLf
                End If
                md = md >> 1
            ElseIf i = 14 Then
                ...
                sVec &= String.Format("  XXXXXXXXXXXXXXX11L;") & vbCrLf
            ElseIf i = 26 Then
                sVec &= String.Format("  XXXXXXXXXXXXXXX01L; RPT 1000;      //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXXXXXXXXXX11L; RPT 1000;") & vbCrLf
            ElseIf i = 27 Then
                sVec &= String.Format("  XXXXXXXXXXXXXXX01X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXXXXXXXXXX11X;") & vbCrLf
            Else
                sVec &= String.Format("  XXXXXXXXXXXXXXX01H;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXXXXXXXXXXXXX11H;") & vbCrLf
            End If
        Next
    ...
    Private Sub Read(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXXXXXXXXXXXXXX11X; RPT 10;        //(RD) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80
        ...
        For i = 0 To 27
            ...
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXXXXXXXXXXXXXX01L;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX11X;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXXXXXXXXXXXXX01H;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXXXXXXXXXXXXX11X;") & vbCrLf
