...
Module vecMC20P22
    ...
    Private Sub PinInfo()
        sw.Write("//PPPPPPPPPPPP" & vbCrLf)
        sw.Write("//111111100000" & vbCrLf)
        sw.Write("//456321001234" & vbCrLf & vbCrLf)
    End Sub
    ...
    Private Sub ProgInit(ByVal nID As Integer)
        ...
        sVec &= String.Format("  XXXX1XX1XXXX; RPT 1000;") & vbCrLf & vbCrLf
        sVec &= String.Format("  XXXX1XX1XXXX; RPT 10;        //(INIT) ID:{0:X4}", nID) & vbCrLf
        m = &H1000
        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXXX0XX1XXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXX1XX1XXXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nID And m) = 0 Then
                    sVec &= String.Format("  XXXL0XX0XXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXL1XX0XXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXL0XX1XXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXL1XX1XXXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i = 27 Then
                sVec &= String.Format("  XXXX0XX1XXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXX1XX1XXXX;") & vbCrLf
            Else
                sVec &= String.Format("  XXXL0XX1XXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXL1XX1XXXX;") & vbCrLf
            End If
        Next
    ...
    Private Sub Write(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXXX1XX1XXXX; RPT 10;        //(WR) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80

        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  XXXX0XX0XXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXH1XX0XXXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nAddr And m) = 0 Then
                    sVec &= String.Format("  XXXH0XX0XXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXH1XX0XXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXH0XX1XXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  XXXH1XX1XXXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXXH0XX0XXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXH1XX0XXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXH0XX1XXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXH1XX1XXXX;") & vbCrLf
                End If
                md = md >> 1
            ElseIf i = 14 Then
                ...
                sVec &= String.Format("  XXXL1XX1XXXX;") & vbCrLf
            ElseIf i = 26 Then
                sVec &= String.Format("  XXXL0XX1XXXX; RPT 1000;      //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXL1XX1XXXX; RPT 1000;") & vbCrLf
            ElseIf i = 27 Then
                sVec &= String.Format("  XXXX0XX1XXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXX1XX1XXXX;") & vbCrLf
            Else
                sVec &= String.Format("  XXXH0XX1XXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  XXXH1XX1XXXX;") & vbCrLf
            End If
        Next
    ...
    Private Sub Read(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  XXXX1XX1XXXX; RPT 10;        //(RD) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80
        ...
        For i = 0 To 27
            ...
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  XXXL0XX1XXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXX1XX1XXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  XXXH0XX1XXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  XXXX1XX1XXXX;") & vbCrLf
