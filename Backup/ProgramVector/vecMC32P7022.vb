...
Module vecMC32P7022
    ...
    Const PAGE As UInt16 = &HFFDB       'One Page
    ...
    Private Sub VecHead()
        sw.WriteLine("HEAD P04,P07,P06,P05,P03,P02,P01,P00;")
        'sw.WriteLine("START:               (XXXXXX00XXXX)TS0;")
    End Sub

    Private Sub VecTail()
        sw.WriteLine("STOP2:               (XXXXX0XX);")
    End Sub
    ...
    Private Sub SendCommand(ByVal cmd As Byte)
        ...
        sVec &= String.Format("RPT 5                (XXXXX0XX);    //Command 0x{0:X2}", cmd) & vbCrLf

        m = &H1
        For i = 0 To 5
            If cmd And m Then
                sVec &= String.Format("                     (XXXXX01X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX11X);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX01X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX10X);    //T{0:D} cmd[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub AddressIn(ByVal addr As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXX0XX);    //Address 0x{0:X4}", addr) & vbCrLf
        ...
        For i = 0 To 15
            If addr And m Then
                sVec &= String.Format("                     (XXXXX01X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX11X);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX01X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX10X);    //T{0:D} addr[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataIn(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXX0XX);    //DataIn 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXXXX01X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX11X);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX01X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX10X);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub DataOut(ByVal data As UInt16)
        ...
        sVec &= String.Format("RPT 5                (XXXXX0XX);    //DataOut 0x{0:X4}", data) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX01XXX);   //T{0:D}", 0) & vbCrLf
        'sVec &= String.Format("               (XXXXXXX00XXX);") & vbCrLf
        ...
        For i = 0 To 15
            If data And m Then
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX10H);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
            Else
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
                sVec &= String.Format("                     (XXXXX10L);    //T{0:D} data[{1:D}]", i, i) & vbCrLf
                sVec &= String.Format("                     (XXXXX00X);") & vbCrLf
            End If
            m <<= 1
        Next
    ...
    Private Sub ProgCtrl()
        ...
        For i = 0 To 7
            sVec &= String.Format("                     (XXXXX1XX);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXX0XX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 1000             (XXXXX0XX);    //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXX1XX);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXX0XX);") & vbCrLf
        Next
        sVec &= String.Format("RPT 20               (XXXXX0XX);") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXXXX1XX);    //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXXXX0XX);") & vbCrLf
        Next
