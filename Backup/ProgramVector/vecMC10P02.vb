...
Module vecMC10P02
    ...
    Const ID As Integer = &H353
    Const ADDRL As Integer = &H1800            'Valid lowest address
    ...
    Private Sub PinInfo()
        sw.Write("//OOPPPPPPVPPPPPPPPI" & vbCrLf)
        sw.Write("//SSBBBBBBPAAAAAAAAR" & vbCrLf)
        sw.Write("//CC234567P01234567O" & vbCrLf)
        sw.Write("//IO               U" & vbCrLf)
        sw.Write("//                 T" & vbCrLf & vbCrLf)
    End Sub
    ...
    Private Sub ProgInit(ByVal nID As Integer)
        ...
        sVec &= String.Format("  0XXXXX1XXXXX1XXXXX; RPT 1000;") & vbCrLf & vbCrLf
        sVec &= String.Format("  0XXXXX1XXXXX1XXXXX; RPT 10;        //(INIT) ID:{0:X4}", nID) & vbCrLf
        m = &H1000
        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  0XXXXX0XXXXX1XXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  0XXXXX1XXXXX1XXXXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nID And m) = 0 Then
                    sVec &= String.Format("  0XXXXX0XXXXL0XXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXL0XXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  0XXXXX0XXXXL1XXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXL1XXXXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i = 27 Then
                sVec &= String.Format("  0XXXXX0XXXXH1XXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  0XXXXX1XXXXH1XXXXX;") & vbCrLf
            Else
                sVec &= String.Format("  0XXXXX0XXXXL1XXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  0XXXXX1XXXXL1XXXXX;") & vbCrLf
            End If
        Next
    ...
    Private Sub Write(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  0XXXXX1XXXXH1XXXXX; RPT 10;        //(WR) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80

        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  0XXXXX0XXXXH0XXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  0XXXXX1XXXXH0XXXXX;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nAddr And m) = 0 Then
                    sVec &= String.Format("  0XXXXX0XXXXH0XXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXH0XXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  0XXXXX0XXXXH1XXXXX;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXH1XXXXX;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  0XXXXX0XXXXH0XXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXH0XXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  0XXXXX0XXXXH1XXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXH1XXXXX;") & vbCrLf
                End If
                md = md >> 1
            ElseIf i = 14 Then
                ...
                sVec &= String.Format("  0XXXXX1XXXXL1XXXXX;") & vbCrLf
            ElseIf i = 26 Then
                sVec &= String.Format("  0XXXXX0XXXXL1XXXXX; RPT 1000;      //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  0XXXXX1XXXXL1XXXXX; RPT 1000;") & vbCrLf
            Else
                sVec &= String.Format("  0XXXXX0XXXXH1XXXXX;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  0XXXXX1XXXXH1XXXXX;") & vbCrLf
            End If
    ...
    Private Sub Read(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  0XXXXX1XXXXH1XXXXX; RPT 10;        //(RD) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80
        ...
        For i = 0 To 27
            ...
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  0XXXXX0XXXXL1XXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXX1XXXXX;") & vbCrLf
                Else
                    sVec &= String.Format("  0XXXXX0XXXXH1XXXXX;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  0XXXXX1XXXXX1XXXXX;") & vbCrLf
