...
Module vecMC10P11B
    ...
    Private Sub PinInfo()
        sw.Write("//SSSSSSSSSSSSSI" & vbCrLf)
        sw.Write("//1110000000000R" & vbCrLf)
        sw.Write("//2109876543210O" & vbCrLf & vbCrLf)
    End Sub
    ...
    Private Sub ProgInit(ByVal nID As Integer)
        ...
        sVec &= String.Format("  X1XXXXXXXXXX1X; RPT 1000;") & vbCrLf & vbCrLf
        sVec &= String.Format("  X1XXXXXXXXXX1X; RPT 10;        //(INIT) ID:{0:X4}", nID) & vbCrLf
        m = &H1000
        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  X0XXXXXXXXXX1X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  X1XXXXXXXXXX1X;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nID And m) = 0 Then
                    sVec &= String.Format("  X0LXXXXXXXXX0X;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  X1LXXXXXXXXX0X;") & vbCrLf
                Else
                    sVec &= String.Format("  X0LXXXXXXXXX1X;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  X1LXXXXXXXXX1X;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i = 27 Then
                sVec &= String.Format("  X0XXXXXXXXXX1X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  X1XXXXXXXXXX1X;") & vbCrLf
            Else
                sVec &= String.Format("  X0LXXXXXXXXX1X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  X1LXXXXXXXXX1X;") & vbCrLf
            End If
        Next
    ...
    Private Sub Write(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  X1XXXXXXXXXX1X; RPT 10;        //(WR) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80

        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  X0XXXXXXXXXX0X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  X1HXXXXXXXXX0X;") & vbCrLf
            ElseIf i >= 1 And i <= 13 Then
                If (nAddr And m) = 0 Then
                    sVec &= String.Format("  X0HXXXXXXXXX0X;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  X1HXXXXXXXXX0X;") & vbCrLf
                Else
                    sVec &= String.Format("  X0HXXXXXXXXX1X;                //T{0:D} addr[{1:D}]", i, 13 - i) & vbCrLf
                    sVec &= String.Format("  X1HXXXXXXXXX1X;") & vbCrLf
                End If
                m = m >> 1
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  X0HXXXXXXXXX0X;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  X1HXXXXXXXXX0X;") & vbCrLf
                Else
                    sVec &= String.Format("  X0HXXXXXXXXX1X;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  X1HXXXXXXXXX1X;") & vbCrLf
                End If
                md = md >> 1
            ElseIf i = 14 Then
                ...
                sVec &= String.Format("  X1LXXXXXXXXX1X;") & vbCrLf
            ElseIf i = 26 Then
                sVec &= String.Format("  X0LXXXXXXXXX1X; RPT 1000;      //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  X1LXXXXXXXXX1X; RPT 1000;") & vbCrLf
            ElseIf i = 27 Then
                sVec &= String.Format("  X0XXXXXXXXXX1X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  X1XXXXXXXXXX1X;") & vbCrLf
            Else
                sVec &= String.Format("  X0HXXXXXXXXX1X;                //T{0:D}", i) & vbCrLf
                sVec &= String.Format("  X1HXXXXXXXXX1X;") & vbCrLf
            End If
        Next
    ...
    Private Sub Read(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  X1XXXXXXXXXX1X; RPT 10;        //(RD) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80
        ...
        For i = 0 To 27
            ...
            ElseIf i >= 17 And i <= 24 Then
                If (nData And md) = 0 Then
                    sVec &= String.Format("  X0LXXXXXXXXX1X;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  X1XXXXXXXXXX1X;") & vbCrLf
                Else
                    sVec &= String.Format("  X0HXXXXXXXXX1X;                //T{0:D} data[{1:D}]", i, 24 - i) & vbCrLf
                    sVec &= String.Format("  X1XXXXXXXXXX1X;") & vbCrLf
