...
Module vecMC10P01B
    ...
    Private Sub Write(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  0XXXXX1XXXXX1XXXXX; RPT 10;        //(WR) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80

        For i = 0 To 27
            If i = 0 Then
                sVec &= String.Format("  0XXXXX0XXXXX0XXXXX;                //T{0:D}", i) & vbCrLf
    ...
    Private Sub Read(ByVal nAddr As Integer, ByVal nData As Integer)
        ...
        sVec &= String.Format("  0XXXXX1XXXXX1XXXXX; RPT 10;        //(RD) Addr:{0:X4} Data:{1:X2}", nAddr, nData) & vbCrLf
        m = &H1000
        md = &H80
