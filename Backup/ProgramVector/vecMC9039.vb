...
Module vecMC9039
    ...
    Private Sub GenWrite()
        Try
            ...
            CmdDataIn(PAGE)
            CmdProg()
            CmdAddress(&H800D)  'write OPBIT1
            CmdDataIn(OPT1 And &HFFFFL)
            CmdProg()
            CmdAddress(&H800E)  'write OPBIT2
            CmdDataIn((OPT1 >> 16) And &HFFFFL)
            CmdProg()
            CmdAddress(&H800F)  'write OPBIT3
    ...
    Private Sub GenVerify()
        Try
            ...
            CmdDataOut(PAGE)
            CmdAddress(&H800D)  'read OPBIT1
            CmdDataOut(OPT1 And &HFFFFL)
            CmdAddress(&H800E)  'read OPBIT2
            CmdDataOut((OPT1 >> 16) And &HFFFFL)
            CmdAddress(&H800F)  'read OPBIT3
    ...
    Private Sub ProgCtrl()
        ...
        Next
        sVec &= String.Format("RPT 1000             (XXX0XX);   //wait prog time") & vbCrLf
        For i = 0 To 3
            sVec &= String.Format("                     (XXX1XX);   //T{0:D}", i) & vbCrLf
            sVec &= String.Format("RPT 5                (XXX0XX);") & vbCrLf
        Next
